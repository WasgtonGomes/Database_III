...
update Procedimento set descricao_pro = 'Procedimento de clareamento dental atualizado' where (nome_pro like '%clareamento%' and valor_pro < 200);
select * from Procedimento where (nome_pro like '%clareamento%' and valor_pro < 200);
select * from Procedimento;
...
select * from Material where (nome_mat like '%resina%' and tipo_mat = 'Estético');
select * from Material;

#40 Atualize o valor do procedimento "Cirurgia" com tempo > 1h e requisitos contendo "anestesia" para R$ 500.

select * from Procedimento where (nome_pro = 'Cirurgia' and tempo_pro > '01:00:00' and requisitos_pro like '%anestesia%');
...
select * from Fornecedor where ((cnpj_for like 'D%' or cnpj_for like 'C%') and nome_fantasia_for like '%LTDA' and (endereco_for like 'Rua%' or endereco_for like 'Av%') and contato_for like '(11)%');
delete from Fornecedor where ((cnpj_for like 'D%' or cnpj_for like 'C%') and nome_fantasia_for like '%LTDA' and (endereco_for like 'Rua%' or endereco_for like 'Av%') and contato_for like '(11)%');
select * from Fornecedor where ((cnpj_for like 'D%' or cnpj_for like 'C%') and nome_fantasia_for like '%LTDA' and (endereco_for like 'Rua%' or endereco_for like 'Av%') and contato_for like '(11)%');
select * from Fornecedor;
...
select * from Funcionario where (rg_fun = '' and email_fun like '%@teste.com');
delete from Funcionario where (rg_fun = '' and email_fun like '%@teste.com');
select * from Funcionario where (rg_fun = '' and email_fun like '%@teste.com');
select * from Funcionario;
